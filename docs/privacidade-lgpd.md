...
Remover Fundo segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Cloudflare** | US | processamento de imagem (segmentação de primeiro plano via Workers AI) e hospedagem do engine |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [removebg@mcp.ai](mailto:removebg@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
